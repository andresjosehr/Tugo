		...
		<div class="hed_content">
			<div class="columns">
				<div class="column col-anf" align="center">
					...
					<span class="anf-btn"><a href="#" class="anf-btn-text"><?php the_field('boton_header'); ?></a></span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="columns caract-contain">
			<div class="column caract-contain2" style="margin-top: 50px;">
				<div align="center" class="tit">
					...
					?>
				<a class="como-hacer" href="<?php echo site_url(); ?>/tutoriales"><?php the_field('llamada_a_la_accion_del_2do_bloque'); ?></a>
			</div>
			<div class="column caract-img-g1" align="left">
				...
				<img class="anf-img2" src="<?php the_field('imagen_del_bloque_2'); ?>" alt="">
			</div>
		</div>
...
<section class="pasos">
	<div class="container">
	<div class="pasos-header" style="padding-top: 53px;" align="center">
			...
			$i=0;
				if( have_rows('contenido_del_3er_bloque') ):
					...
					if ($i==1 || $i==3) {
				   	...
				   	if ($i==1) {
				   		?>
						<div class="column is-6 pasos3" align="center">
	...
	<a class="como-ser" href="<?php echo site_url(); ?>/ser-anfitrion"><?php the_field('llamada_a_la_accion_del_3er_bloque'); ?></a>
	</div>
	<br><br>
	</div>
</section>
...
<section class="porque">
	<div class="container">
		<div class="pasos-header pashed1" style="padding-top: 50px;" align="center">
			<span class="pasos-title" ><?php the_field('titulo_del_4to_bloque'); ?></span><hr class="anf-hr ray3"><br><br>
		</div>
		<div class="pasos-header pashed2" align="center"><br>
		...
		<div class="content">
			<div class="autoplay">
				<div align="center">
					<div class="columns">
						<div class="column porq-div" align="center">
								...
								$i=0;
									if( have_rows('contenido_del_4to_bloque') ):
									    ...
									    ?>
											...
											<a class="como-ser" href="<?php echo site_url(); ?>/ser-anfitrion"><?php the_sub_field('llamada_a_la_accion'); ?></a>
										<?php
									    endwhile;
									else :
									    // no rows found
 	...
 	<div class="columns">
		...
		$i=1;
			if( have_rows('contenido_del_5to_bloque') ):
			    ...
			    ?>
				 		<div class="column cols" align="center">
		...
		<div class="req-tit" style="">
			...
			$i=0;
				if( have_rows('contenido_1_del_6to_bloque') ):
				    ...
				    ?>
							<div class="columns">
								<div class="column req-456" align="left">
									<div class="req-tit2">
				...
				if( have_rows('contenido_2_del_6to_bloque') ):
				    ...
				    <div class="intermed" style="display: none">
								...
								<div class="column">
									<div class="requisitos-col2">
										<div class="intermed0">
											...
											<a class="como-ser com-1" href="<?php echo site_url(); ?>/ser-anfitrion"><?php the_sub_field('llamada_a_la_accion'); ?></a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="columns com-2" style="display: none">
								<div class="column" align="center">
									<a class="como-ser"><?php the_sub_field('llamada_a_la_accion'); ?></a>
								</div>
							</div>				
					<?php
					$i++;
				    ...
				    ?>
							<div class="column life-col1" align="center">
									<div class="ant-foot">
										...
										<span class="btn-des2"><a class="btn-con2" href="<?php echo site_url(); ?>/ser-anfitrion"><?php the_sub_field('boton'); ?></a></span>
									</div>
								</div>
								<div class="column cel-anf">
