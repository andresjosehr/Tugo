	...
	<div class="container">
		<div class="columns caract-contain">
			<div class="column caract-contain2" style="margin-top: 50px;">
				<div align="center" class="tit wow lightSpeedIn">
					...
					<?php 
						...
						if( have_rows('contenido_del_bloque_2') ):
						    ...
						    ?>
							<div class="column wow zoomInLeft">
			...
			<div class="column caract-img-g1" align="left">
				...
				<img class="anf-img2 wow lightSpeedIn" src="<?php the_field('imagen_del_bloque_2'); ?>" alt="">
			</div>
		</div>
...
<section class="pasos">
	<div class="container">
	<div class="pasos-header wow slideInDown" style="padding-top: 53px;" align="center">
	...
	<div class="columns pasos4">
			...
			$i=0;
				if( have_rows('contenido_del_3er_bloque') ):
				    ...
				    ?>
					<div class="columns wow rotateInUpLeft">
					...
					if ($i==1 || $i==3) {
				   	...
				   	if ($i==1) {
				   		?>
						<div class="column is-6 pasos3 wow bounceInUp" align="center">
...
<section class="porque">
	<div class="container">
		<div class="pasos-header pashed1 wow tada" style="padding-top: 50px;" align="center">
			<span class="pasos-title" ><?php the_field('titulo_del_4to_bloque'); ?></span><hr class="anf-hr ray3"><br><br>
		</div>
		<div class="pasos-header pashed2 wow tada" align="center"><br>
		...
		<div class="content">
			<div class="autoplay">
				<div align="center">
					<div class="columns">
						<div class="column porq-div wow wobble" align="center">
						...
						<div class="column col-2-anf" align="center">
							<div class="porque-col-right wow jello">
								<?php 
								$i=0;
 	...
 	<div class="columns">
		...
		$i=1;
			if( have_rows('contenido_del_5to_bloque') ):
			    ...
			    ?>
				 		<div class="column cols wow flipInX" align="center">
...
<section class="requisitos">
	<div class="container">
		<div class="req-tit wow rotateIn">
			...
			$i=0;
				if( have_rows('contenido_1_del_6to_bloque') ):
				    ...
				    ?>
							<div class="columns">
								<div class="column req-456 wow swing" align="left">
									<div class="req-tit2">
								...
								<div class="column wow fadeInRight" align="center">
			...
			$i=0;
				if( have_rows('contenido_2_del_6to_bloque') ):
				    ...
				    <div class="intermed" style="display: none">
							...
							<div class="columns">
								<div class="column wow swing" align="center">
									<img class="requisitos-img" src="<?php the_sub_field('imagen'); ?>" alt="">
								</div>
								<div class="column">
									<div class="requisitos-col2">
										<div class="intermed0 wow fadeInRight">
											<span class="requisitos-sub"><?php the_sub_field('subtitulo'); ?></span><br><br>
											<p class="requisitos-text">
												<?php the_sub_field('contenido'); ?>
											</p><br>
				...
				if( have_rows('contenido_del_7mo_bloque') ):
				    ...
				    ?>
							<div class="column life-col1" align="center">
									<div class="ant-foot wow fadeInLeft">
								...
								<div class="column cel-anf wow rotateIn">
