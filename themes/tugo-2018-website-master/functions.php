...
// Codigo programado por Jose Andres =D
...
<div class="pre-blog-sect" style="display: none;">
	<span>BLOG</span>	
</div>

	<section class="sub-blog-sect" style="height: 75px;">		
		<div class="columns">
			<div class="column is-2 men-elemt">
				<li class="sub-blog-li more-7">
					<span class="sub-blog-a-button">BLOG</span>
				</i>
			</div>
				...
				<div class="slick-esp">
					<div class="multiple-items">
					 <?php 
									$categories = get_categories();
										foreach($categories as $category) {			
											echo '<div class="cat-sld sub-blog-li"><a href="' . get_category_link($category->term_id) . '">'.$category->name.'</a></div>';
										}						
										?>	
					</div>
				</div>	
  	...
  	<div class="columns" >
  		<div class="column" align="center">
  			<div class="foot-col-1">
  				...
  				<p class="foot-text" align="justify">Canlove es una app diseñada para ayudarte a encontrar al mejor paseador, las mejores estancias y el mejor hospedaje para tu perro.</p>
  			</div>
  		</div>
  		<div class="column col-footer-2" align="left">
			<a href="<?php echo get_site_url().'/#caracteristicas'; ?>">Características</a>
			<a href="<?php echo get_site_url().'/#comofunciona'; ?>">¿Como funciona?</a>
			<a href="<?php echo get_site_url().'/#canlover'; ?>">Canlover</a>
			<a href="<?php echo get_site_url().'/#servicios'; ?>">Servicios</a>
			<a href="https://techlatam.typeform.com/to/c1Omz4" target="_blank" >Ser Canlover</a>
  		</div>
  		<div class="column col-footer-3" align="center">
  			<span>Contactanos</span><br><br>
  			<i class="fab fa-facebook-f fa-3x"></i>
  			<i class="fab fa-instagram fa-3x instagram"></i>
  		</div>
  	</div>
  </div>
  <div class="columns col-footer-ult">
  	<div class="column is-5"><p class="cop"> &#169; Canlove. Todos los derechos reservados 2018</p></div>
  	<div class="column is-3" align="center"><p class="cop"> Politica de Privacidad</p></div>
  	<div class="column is-3" align="center"><p class="cop"> Terminos y condiciones</p></div>
  </div>
</footer>
...
<script>
   ...
   function updateColorHeader() {
    if ($(window).scrollTop() > 80) {
        ...
        $('.prin').css("background-color", "transparent");
        $('.prin').css("height", "125px");
        $('.prin .header__menu a').css("color", "#FFF");
        $( ".menu-item-181 a" ).removeClass( "button8top" );
        $( ".menu-item-181 a" ).addClass( "button8normor" );
        $('.prin .header__menu--button a').css("color", "#2454D6");
        $('.prin .header__menu--button a').css("background-color", "#FFF");
        $('.prin .header__logo img').attr("src", $('.header__logo img').data("dark"));
        $('.prin #nav-icon3 span').css("background-color", "#FFF");
...
// Fin de codigo programado por Jose Andres
